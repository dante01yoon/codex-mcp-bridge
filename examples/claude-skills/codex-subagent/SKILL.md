...
description: Orchestrates task delegation to Codex via MCP bridge. Automatically selects the right tool, sandbox mode, and output format based on the task type.
user-invocable: true
allowed-tools:
